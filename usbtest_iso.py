...
dev = usb.core.find(idVendor=0x1004, idProduct=0xA000 )
...
TOTAL_TRANSFER_SIZE = TIMEOUT*MSEC_TRANSFER_COUNT*(epIsoIn.wMaxPacketSize&0x7ff)*(MC+1)
...
if elapsed_time >0:
    ...
    print(f"Transfer Speed: {(transfer_speed/1024/1024)} MB/sec")
else:
